...
// - Позицию Тёпы
// - Собранные косточки
// - Приручённых единорожков
// - Поставленные блоки
//
// Автосохранение каждые 10 секунд + при закрытии вкладки
// ============================================================
...
const Save = {
    ...
    load() {
        try {
            ...
            // Позиция Тёпы (y не ниже уровня земли)
            if (data.dog) {
    ...
    // Автосохранение — вызывать из game loop
    update(dt) {
